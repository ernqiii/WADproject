...
router.post('/', auth.isLoggedIn, listingController.handleUpload('createListing'), listingController.createListing);

router.get('/:id/edit', auth.isLoggedIn, listingController.editListing);
router.post('/:id/edit', auth.isLoggedIn, listingController.handleUpload('editListing'), listingController.updateListing);
