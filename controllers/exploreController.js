...
const addComment = async (req, res) => {
  try {
    ...
    const updated = await Listing.findById(req.params.listingId).populate('comments.user', 'username');
...
module.exports = { getExploreListings, likeListing, addComment, editComment, deleteComment };